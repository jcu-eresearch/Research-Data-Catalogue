...
#JCU: updated version from base. Contains no JCU customisations.
#The original 1.9 release was missing "'" around the Z on line 76.
...
class IndexData:
    ...
    def __newDoc(self):
        ...
        if str(current_date_object_created).endswith("Z"):
            ...
            formatterWithTZ = SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss'Z'")
