...
# JCU: this verison was added the original version with the 1.9 release prevented the self submission from working.
# This is from a newer base version.
# There are no JCU customisations.
...
class IndexData:
    ...
    def __newDoc(self):
        ...
        self.log.info("Jay: Current date object created is: %s" % current_date_object_created)
        formatterWithoutTZPattern = "yyyy-MM-dd'T'HH':'mm':'ss"
        #if str(current_date_object_created).endswith("Z"):
        #    self.log.info("Jay: Attempting to parse existing solr date created with UTC format..")
        ...
        #    self.log.info("Jay: parsed 'date_object_created' is: %s" % formattedTZCreatedDateTime)
        ...
        #    self.log.info("Jay: timezone-stripped date time is: %s" % dateTimeWithoutTZ)
        #else:
        #    self.log.info("Jay: Attempting to parse existing solr date created, presuming an ISO timezone format..")
        ...
        #    self.log.info("Jay: parsed 'date_object_created' is: %s" % formattedTZCreatedDateTime.toString())
        ...
        #self.log.info("'Jay: date_object_created' will be: %s" % formattedCreatedDateTime)
        #self.utils.add(self.index, "date_object_created", formattedCreatedDateTime)
        self.utils.add(self.index, "date_object_created", current_date_object_created)
