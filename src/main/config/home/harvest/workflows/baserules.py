...
#JCU: added as the base version from the 1.9 github repo prevents the user from creating a self submission record.
#This updated version came from Andrew Brazatti.
#There are no JCU customisations in this file
